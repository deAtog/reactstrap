...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        attributes = _objectWithoutPropertiesLoose(_this$props, ["className", "label", "valid", "invalid", "cssModule", "children", "bsSize", "innerRef", "htmlFor", "type", "onChange"]);
...
CustomFileInput.propTypes = propTypes$z;
...
var propTypes$16 = _extends({}, Transition.propTypes, {
  isOpen: PropTypes.bool,
  children: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.node), PropTypes.node]),
  tag: tagPropType,
